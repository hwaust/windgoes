...
{
    /// <summary>
    /// 农历日期类，提供了输出农历日期计算，中文日期输出，星座输出等功能, 日期计算从1901年-2050年。
    /// </summary>
    public class LunaMonth
    {
        #region Data
	  ...
	  "立冬", "小雪", "大雪", "冬至"};
        ...
        /// <summary>
        /// 农历日期类，提供了输出农历日期计算，中文日期输出，星座输出等功能。
        /// </summary>
        public LunaMonth()
        {
            Date = DateTime.Today;
        ...
        /// 农历日期类，提供了输出农历日期计算，中文日期输出，星座输出等功能。
        /// </summary>
        /// <param name="dt">农历日期对应的公历日期。</param>
        public LunaMonth(DateTime dt)
        {
            Date = dt.Date;
        } 
        #endregion
        ...
        {
            ushort iLunarYear =(ushort) m_Date.Year;
            byte Flag;
        ...
        /// <summary>
        /// 返回阴历iLunarYer年阴历iLunarMonth月的天数，如果iLunarMonth为闰月，高字为第二个iLunarMonth月的天数，否则高字为0 1901年1月---2050年12月
        /// </summary> 
        /// <returns></returns>
        public uint LunarMonthDays()
        {
            ushort iLunarYear = (ushort) m_Date.Year;
            ushort iLunarMonth = (ushort)m_Date.Month;
            int Height, Low;
            int iBit;
            if ((iLunarYear < START_YEAR) || (iLunarYear > END_YEAR))
            { return 30; }
